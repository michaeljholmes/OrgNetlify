...
- Define and uphold engineering standards (testing, security, performance, and maintainability).
- Lead complex debugging and incident response, including identifying root causes and driving preventative improvements.
### Core Responsibilities
@import "./DeveloperResponsibilities.md"